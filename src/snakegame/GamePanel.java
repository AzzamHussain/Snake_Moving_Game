...
public class GamePanel extends JPanel implements ActionListener,KeyListener{
    ...
    private int[]yPos={25,50,75,100,125,150,175,200,225,250,275,300,325,350,375,400,425,450,475,500,525,550,575,600,625};
    ...
    private void collidesWithBody() {
        for(int i=lengthOfSnake-1;i>0;i++){
             if(snakexlength[1]== snakexlength[0]&& snakeylength[1]==snakeylength[0]){
                  timer.stop();
                  gameOver=true;
             }
        }
